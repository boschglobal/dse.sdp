...
func TestGenerateSimulation(t *testing.T) {
	...
	YamlContains(t, f, "$.spec.models[1].channels[0].alias", "scalar_channel")
	YamlContains(t, f, "$.spec.models[1].channels[0].selectors.channel", "scalar_vector")
	...
	YamlContains(t, f, "$.spec.models[2].model.name", "dse.fmi.mcl")
	YamlContains(t, f, "$.spec.models[2].runtime.paths[0]", "model/linear/data")
	YamlContains(t, f, "$.spec.models[2].channels[0].name", "physical")
	YamlContains(t, f, "$.spec.models[2].channels[0].alias", "scalar_channel")
	YamlContains(t, f, "$.spec.models[2].channels[0].selectors.channel", "scalar_vector")
